...
user_profiles_df_all = pd.read_pickle("./remote_save/user_profiles_df_all-reduced.pkl")
df_articles = pd.read_pickle("./remote_save/df_articles-reduced.pkl")
article_embeddings_df = pd.read_pickle("./remote_save/article_embeddings_df-reduced.pkl")
